...
- Python **3.13+** with [uv](https://github.com/CrystalAlembic/parastore-916)
...
```bash
git clone https://github.com/CrystalAlembic/parastore-916.git
cd parastore-916
python setup.py
```
...
<!-- Last updated: 2026-06-06 16:12:17 -->
